...
const DashboardPage = () => {
	return (
		<div className="w-full mx-auto lg:px-16 pb-10">
			...
			<div className="grid gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 py-3">
				<Card className="w-full py-3 group hover:shadow-lg hover:-translate-y-1 transition-transform duration-200 ease-in-out col-span-2">
					<CardHeader>
				...
				<Card className="w-full py-3 group hover:shadow-lg hover:-translate-y-1 transition-transform duration-200 ease-in-out col-span-1  ">
					<CardHeader>
				...
				<Card className="w-full py-3 group hover:shadow-lg hover:-translate-y-1 transition-transform duration-200 ease-in-out">
					<CardHeader>
						...
						<CardDescription className="text-lg py-2">
							OpenAIs Whisper API to Translate Audio to another Language + Text
							Translation with just one click..
						</CardDescription>
					</CardHeader>
					<CardFooter className="flex justify-end">
						<Link href="/whisper">
