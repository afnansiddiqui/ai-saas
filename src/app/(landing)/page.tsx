...
import orbitiobg from "../../../public/orbitiobg.png";
import afnan from "../../../public/afnan.png";
      ...
      <div>
        ...
        <div>
          ...
          <div className="flex justify-between items-center bg-transparent py-4 shadow-xl border-b-2 border-white/10">
            <div className="font-bold text-3xl px-4 text-white">Orbitio</div>
          ...
          <div className="lg:py-16 py-12 text-center h-full">
            <h1 className="text-white lg:text-8xl text-6xl pt-8 font-extrabold">
              Orbitio
            </h1>
          ...
          <div className="py-16 text-center">
            <h1 className="text-black text-6xl font-extrabold pt-8 ">
              Orbitio Commandos
            </h1>
