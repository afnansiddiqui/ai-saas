        ...
        <>
            ...
            <div className="h-full  sm:flex sm:px-16 sm:justify-around ">
                <div className="px-4 pt-[10rem] sm:py-[12rem] md:col-span-6 col-span-12 text-center sm:text-left">
                    ...
                    <p className="text-[#fff] p-2 ">
                        Welcome to Orbitio - Your Gateway to AI-Powered Innovation and Creativity.
                    </p>
                    <div className="">
                        <Link href="/sign-up">
            ...
            <div className="flex justify-center py-10 px-6 lg:px-0 mt-24 sm:mt-0">
                <iframe
                    width="900"
                    height="400"
                    src="https://www.youtube.com/embed/wW2rUHkT0V4?si=PlAjDkenB7GT0rFB"
            ...
            <section className="py-16 text-white grid sm:grid-cols-2 gap-4 px-8">
                <div className="self-center order-2">
                    ...
                    <p className="pt-23">Welcome to <span className="font-bold">Orbitio</span>, a groundbreaking platform where innovation meets imagination. Our team of four dedicated members have developed state-of-the-art AI models that cater to a wide range of applications. From engaging conversation models and efficient code generation to creative image generation and 3D modeling, Orbitio is your one-stop solution for AI-powered projects. With just one click, you can even design your desired T-shirt in 3D! In total, we offer seven exciting projects that are set to revolutionize the way you interact with technology. Join us on this journey as we continue to push the boundaries of what is possible with AI.
                    </p>
                </div>
